    ...
    >
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-6xl">
        ...
        <div className="grid grid-cols-2 gap-4 md:grid-cols-4 mb-8">
          ...
          <div className="rounded-2xl border border-border bg-card p-5 shadow-sm transition-all duration-300 hover:border-primary/20">
            ...
            <div className="mt-4">
              ...
              <p className="text-[10px] text-muted-foreground mt-1">Total in last 12 months</p>
            </div>
          </div>
          ...
          <div className="rounded-2xl border border-border bg-card p-5 shadow-sm transition-all duration-300 hover:border-primary/20">
            ...
            <div className="mt-4">
              ...
              <p className="text-[10px] text-muted-foreground mt-1">Consecutive active days</p>
            </div>
          </div>
          ...
          <div className="rounded-2xl border border-border bg-card p-5 shadow-sm transition-all duration-300 hover:border-primary/20">
            ...
            <div className="mt-4">
              ...
              <span className="text-sm font-medium text-muted-foreground ml-1">days</span>
              <p className="text-[10px] text-muted-foreground mt-1">All-time record streak</p>
            </div>
          </div>

          {/* Card 4: Public Repos / Followers */}
          <div className="rounded-2xl border border-border bg-card p-5 shadow-sm transition-all duration-300 hover:border-primary/20">
            <div className="flex items-center justify-between text-muted-foreground">
            ...
            <div className="mt-4">
              ...
              <p className="text-[10px] text-muted-foreground mt-1">Repositories on GitHub</p>
            </div>
          </div>
        </div>

        {/* ── 2. Grid for Heatmap and Pinned Repos ── */}
